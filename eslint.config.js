  ...
  */
  {
    ...
    rules: {
      /** Disable extant ESLint (base) rules that conflict with Prettier (even if Prettier is no longer used)
       * Reference (ESLint base rules): https://eslint.org/docs/latest/rules/
       */
      "arrow-body-style": off,
      "prefer-arrow-callback": off,

      /** Enable @typescript-eslint rules with no corresponding ESLint (base) rule:
       * Reference (@typescript-eslint all rules): https://typescript-eslint.io/rules/
      */
      ...
      */
      ...
      /** Enable @stylistic/eslint-plugin style rules
       * Reference (@stylistic/ rules for default package): https://eslint.style/packages/default#rules
      **/
