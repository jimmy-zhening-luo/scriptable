...
declare const QuickLook: {
   ...
   */
  present: (item: unknown, fullscreen?: boolean)=> Promise<void>;
};
...
declare const ShareSheet: {
   ...
   */
  present: (activityItems: readonly unknown[])=> Promise<ShareSheet.ShareSheetResult>;
};
...
declare class WebView {
   ...
   */
  evaluateJavaScript(javaScript: string, useCallback?: boolean): Promise<unknown>;
...
/**
   ...
   */
  didStartElement: (arg0: string, arg1: Record<string, string>)=> void;
