...
class Host extends ho_UrlPart {
    ...
    static get HostIPv4Repeater() {
        try {
            ...
            throw new ReferenceError(`Host: error loading HostIPv4Repeater module: \n${e}`);
        }
    }
    static get HostIPv6Repeater() {
        try {
            ...
            throw new ReferenceError(`Host: error loading HostIPv6Repeater module: \n${e}`);
        }
    }
    static get HostRegNameRepeater() {
        try {
            ...
            throw new ReferenceError(`Host: error loading HostRegNameRepeater module: \n${e}`);
        }
    }
    static get UrlPart() {
        try {
            ...
            throw new ReferenceError(`Host: error loading parent UrlPart module: \n${e}`);
        }
    }
    parse(host) {
        try {
