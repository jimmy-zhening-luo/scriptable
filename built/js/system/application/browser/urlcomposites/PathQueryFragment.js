...
class PathQueryFragment extends pqf_UrlComposite {
    constructor(pathOrPathQueryOrPathQueryFragment, fragment) {
        ...
        try {
                ...
                = pathOrPathQueryOrPathQueryFragment === undefined
                    ...
                    : pathOrPathQueryOrPathQueryFragment instanceof PathQueryFragment
                        ...
                        : Array.isArray(pathOrPathQueryOrPathQueryFragment)
                            ? [
                                new PathQueryFragment.PathQuery(new PathQueryFragment.PathQuery.Path(pathOrPathQueryOrPathQueryFragment[0]), new PathQueryFragment.PathQuery.Query(pathOrPathQueryOrPathQueryFragment[1])),
            ...
            throw new SyntaxError(`PathQueryFragment: constructor: error creating PathQueryFragment: \n${e}`);
        }
    }
    static get PathQuery() {
        try {
            return importModule("PathQuery");
        }
        catch (e) {
            throw new ReferenceError(`PathQueryFragment: get PathQuery: error loading PathQuery module: \n${e}`);
        }
    }
    static get Fragment() {
        try {
            ...
            throw new ReferenceError(`PathQueryFragment: get Fragment: error loading Fragment module: \n${e}`);
        }
    }
    static get UrlComposite() {
        try {
            ...
            throw new ReferenceError(`PathQueryFragment: get UrlComposite: error loading UrlComposite module: \n${e}`);
        }
    }
    get composite() {
        try {
            ...
            throw new EvalError(`PathQueryFragment: get composite: error getting composite: \n${e}`);
        }
    }
}
