...
namespace HostIPv6Repeater {
  export const _ValidHostIPv6Repeater: typeof ValidHostIPv6Repeater = importModule("./system/application/browser/urlcomposites/urlparts/validators/ValidHostIPv6Repeater");
}
