...
abstract class Shortcut extends _Application {
  ...
  get input(): any {
    try {
      ...
      console.error(`Shortcut.js: Error getting shortcut input from Scriptable 'args' object (which by design is loaded with any input parameters passed from Shortcuts when executing a Scriptable script): ${e}`);
      throw e;
    }
  }
