declare namespace Tuple {
  ...
  type getter<Reference> = Reference extends readonly [...infer MutableReference]
    ? MutableReference
    : never;
  type gettertest = getter<Tuple | Tuple<3>>;
type john = [string] | [string, string] extends readonly [string] | readonly [string, string] ? true : false;
type god = Bound<1 | 3, Tuple<1> | Tuple<3>>;
